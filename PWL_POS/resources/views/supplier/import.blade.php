<form action="{{ url('/supplier/import_ajax') }}" method="POST" id="form-import-supplier"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ asset('template_xlsx/template_supplier.xlsx') }}" class="btn btn-info btn-sm" download>
