<form action="{{ url('/level/import_ajax') }}" method="POST" id="form-import-level"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ asset('template_xlsx/template_level.xlsx') }}" class="btn btn-info btn-sm" download>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status) {
                            ...
                            dataLevel.ajax.reload(); // reload datatable level
                        } else {
                            $('.error-text').text('');
